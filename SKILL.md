...
| header | `选择活动名` |
| question | `选择最匹配的活动名称` |
| 选项 | ① `black-friday` — 黑色星期五 ② `spring-sale` — 春季大促 ③ `other` — 从词库选其他 |
...
| header | `触达方式` |
| question | `通过什么方式触达？` |
| 选项 | ① `达人合作` — influencer ② `广告投放` — paid-social ③ `邮件营销` — email ④ `其他` — 手动输入 |
...
| header | `发布平台` |
| question | `在哪个平台发布？` |
| 选项 | ① `Instagram` ② `TikTok` ③ `Facebook` ④ `其他` — 手动输入 |
...
| 选项 | ① `ig-story` — Story 链接 ② `ig-post` — Post 链接 ③ `bio` — Bio 链接 ④ `其他` — 手动输入 |
